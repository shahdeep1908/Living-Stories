...
<body>
	...
	<section class="contact-section">
              ...
              <form class="contact-form" action="upload" method="post" enctype="multipart/form-data">
                     <div class="col-lg-4">
                     	<label>SELECT THE IMAGE YOU WANT TO UPLOAD 	: <label>
                     </div>
                     <div class="col-lg-4">
                      <input type="file" size="50" name="fileToUpload" id="fileToUpload"/>
                     </div>
                     <div class="col-lg-4">
                    <button class="site-btn sb-big" type="submit">Upload File</button>
                    </div>
			</form>
	</section>
