...
<%
	...
	try
	{
		 ...
		 String user = "select username from images where imagename = ?";
		...
		String fetch_image = "select imagename from images where imagename = ?";
						...
						<div class="property-info-bar">
							<div class="row">
								...
								<div class="col-lg-5 text-left text-lg-right">
									<a href="BuyerLogin.jsp" class="offer-btn">Make an Offer</a>
								</div>
							</div>
						</div>
