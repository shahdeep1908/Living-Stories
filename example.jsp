...
<div class="container" id="container">
	<div class="form-container sign-up-container">
    	<form method="post" action="register">
				...
				<input type="text" placeholder="Location" required="true" name="location" class="min">
                <br />
	...
	<div class="form-container sign-in-container">
		<form method="post" action="Login"> 
				<h1>Sign in</h1> <br />
				<input type="text" placeholder="Username" required="true" name="l_username">
				<input type="password" placeholder="Password" required="true" name="password">
				<input type="password" placeholder="Confirm Password" required="true" name="cpassword" class="min"> <br />
